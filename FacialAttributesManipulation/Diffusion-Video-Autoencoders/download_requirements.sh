...
echo "Downloading model checkpoints.."
wget "https://drive.google.com/uc?export=download&id=1J_eAs5-KWn--kmcqx5S-QjVPskTczTMU" -O "checkpoints/diffusion_video_autoencoder/latent.pkl"
gdown 1Q6z7Wmo9xve5SgfDJExohpDSSNi4QxcH -O "checkpoints/diffusion_video_autoencoder/epoch=51-step=1000000.ckpt"

echo "Downloading classifier checkpoints.."
gdown 1nddbwuAvIVEqKkkmUF96nJj91jVmAdtR -O "checkpoints/diffusion_video_autoencoder_cls/last.ckpt"

echo "Downloading pre-trained models checkpoints.."
gdown 1X2u83hSO2jObO6pCCpZXa45qpQU2ECKJ -O "pretrained_models.zip"
echo "Unzip pre-trained models.."
unzip pretrained_models.zip

# echo "Downloading CelebA datasets for training classifier.."
# gdown 1Kk7U6aeuQCY2-lhOOXxzTbxa5AYidsK2 -O "datasets.zip"
# echo "Unzip CelebA datasets.."
# unzip datasets.zip