...
FROM nvcr.io/nvidia/cuda:10.1-cudnn7-devel-ubuntu18.04 as builder
...
RUN pip install opencv_python==4.6.0.66 numpy==1.16.6 python_speech_features==0.6 resampy==0.2.2 scipy==1.5.4 tensorflow==1.15.2
